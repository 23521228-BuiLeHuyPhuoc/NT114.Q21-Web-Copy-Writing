  ...
  const plans = [
    {
      ...
      excludedFeatures: ['GPT-4', 'Fine-tuning Studio', 'API Access', 'Xuất file (.docx, .pdf)'],
      allowedModels: ['gemini-flash-lite'],
      isPopular: false,
      isActive: true,
      sortOrder: 1,
    },
    {
      ...
      features: ['500 copy/tháng', '100+ template', 'GPT-4 + GPT-3.5 + Llama 3.1', 'Fine-tuning Studio (3 models)', 'API Access (5.000 calls/tháng)'],
