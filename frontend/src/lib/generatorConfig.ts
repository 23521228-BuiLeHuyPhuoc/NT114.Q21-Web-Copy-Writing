...
export const MODELS = [
  ...
  { id: 'freegpt4-gpt-4', name: 'GPT-4 Free Local API', badge: 'Local', color: 'text-indigo-600', desc: 'Local Free-GPT4-WEB-API model when localhost provider is enabled.', latency: '~5-30s', tokens: 'provider' },
  { id: 'freegpt4-gpt-4o', name: 'GPT-4o Free Local API', badge: 'Local', color: 'text-violet-600', desc: 'Local Free-GPT4-WEB-API GPT-4o compatible route.', latency: '~5-30s', tokens: 'provider' },
];
