...
export function ConfirmDialog({
  ...
  const variantMap = {
    danger:  { btn: 'bg-red-600 hover:bg-red-700 shadow-red-200/60',   icon: <Trash2 className="w-5 h-5" />,      ring: 'bg-destructive/10',   iconColor: 'text-red-600' },
    warning: { btn: 'bg-warning/100 hover:bg-amber-600 shadow-amber-200/60', icon: <AlertTriangle className="w-5 h-5" />, ring: 'bg-warning/15', iconColor: 'text-amber-600' },
    success: { btn: 'bg-primary hover:bg-green-700 shadow-primary/20', icon: <RotateCcw className="w-5 h-5" />,  ring: 'bg-primary/10', iconColor: 'text-primary' },
  };
